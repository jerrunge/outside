...
{id:'halfdome',name:'Half Dome — Happy Isles → Sunrise Creek',type:'backpack',region:'Yosemite · Valley',drive:4,len:'3 nts',miles:'~6/day',gain:'≤2,900/day',
 ...
 blurb:'Happy Isles up the JMT by Clark Point to a camp on Sunrise Creek past LYV, then the cables from camp. Booked: Sep 29 to Oct 2, 2026. EPIC.',
 d:{tag:'Up the JMT from Happy Isles to a camp on Sunrise Creek past Little Yosemite Valley, then the cables to the top of Half Dome from camp. Booked, Sep 29 to Oct 2.',
