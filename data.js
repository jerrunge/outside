...
{id:'twentylakes',name:'Twenty Lakes Basin',type:'backpack',region:'Hoover · Saddlebag',drive:4.5,len:'2 nts',miles:'~6/day',gain:'≤1,400/day',
 ...
 d:{tag:'A whole basin of cobalt lakes at 10,000 ft — and a boat that skips the first two miles.',
  ...
  route:{mode:'backpack',options:[
   {name:'Water-taxi loop',stat:'2 nts · ~6 mi/day · ≤1,400 ft',text:'Taxi across Saddlebag, hike the basin loop counter-clockwise past Greenstone, Wasco, Steelhead and Helen; camp two nights at Steelhead or Shamrock; taxi back. Maximum lakes, minimum miles.'},
   {name:'Full foot loop',stat:'2 nts · ~7 mi/day',text:'Skip the boat, walk both shores of Saddlebag. Adds ~4 mi round trip and a quieter east-shore approach.'}]},
  ...
  permit:{system:'Hoover Wilderness overnight permit (Humboldt-Toiyabe, via recreation.gov), Saddlebag/20 Lakes entry.',cost:'$6/permit + per-person fee',where:'recreation.gov',when:'Quota season; reserve ahead for weekends',notes:'Bear canister recommended/required by area. Verify the Saddlebag water-taxi is running (resort operations vary year to year).'},
  drive:{time:'~4.5 hr',route:'Hwy 120 over Tioga Pass; Saddlebag Lake Rd just east of the park gate',flags:['Tioga Pass closed in winter/heavy snow — confirm open','Saddlebag Rd is rough gravel']},
  ...
  verify:['Water-taxi operating status & hours','Tioga Pass open','Hoover quota for your dates','Bear-can requirement for entry']}},
...
{id:'carsonpass',name:'Carson Pass — Winnemucca & Round Top',type:'backpack',region:'Mokelumne · Carson Pass',drive:3.5,len:'1–2 nts',miles:'~6/day',gain:'≤1,800/day',
 ...
 d:{tag:'The easiest yes on the list — peak wildflower theater under Round Top, 3.5 hours from home.',
  ...
  route:{mode:'backpack',options:[
   {name:'Winnemucca overnight',stat:'1 nt · ~2.5 mi in',text:'Quick climb to Winnemucca Lake, camp on the bench, day-hike toward Round Top. Ideal first-night-of-the-season trip.'},
   {name:'Winnemucca–Round Top loop',stat:'2 nts · ~6 mi/day',text:'Continue to Round Top Lake and Fourth of July Lake for a fuller loop with more solitude on the back half.'}]},
...
{id:'littlelakes',name:'Little Lakes Valley',type:'backpack',region:'E. Sierra · Rock Creek',drive:5.5,len:'2 nts',miles:'~6/day',gain:'≤1,200/day',
 ...
 d:{tag:'Start at 10,300 ft — the highest paved trailhead in the Sierra — and walk a staircase of lakes into the high peaks.',
  ...
  route:{mode:'backpack',options:[
   {name:'Long Lake basecamp',stat:'2 nts · ~6 mi/day · ≤1,200 ft',text:'Easy walk in to Long Lake, camp two nights, day-trip up to Gem Lakes and Morgan Pass. Fish the whole chain from one base.'},
   {name:'Gem Lakes push',stat:'2 nts · ~7 mi/day',text:'Continue past Long to the Gem Lakes for the highest, quietest water and the best golden fishing.'}]},
...
{id:'shadow',name:'Shadow & Ediza Lakes',type:'backpack',region:'Ansel Adams · Agnew Mdws',drive:5.5,len:'2–3 nts',miles:'~8/day',gain:'≤2,300/day',
 ...
 d:{tag:'The Minarets mirrored in Ediza Lake — one of the most photographed scenes in the Sierra.',
  ...
  route:{mode:'backpack',options:[
   {name:'Ediza basecamp',stat:'2 nts · ~8 mi/day · ≤2,300 ft',text:'Agnew Meadows to Ediza (camp 1/8 mi off the south shore per regs), day-trip to Iceberg and Cecile Lakes under the Minarets.'},
   {name:'Thousand Island extension',stat:'3 nts · ~8–9 mi/day',text:'Loop out via Garnet and Thousand Island Lakes on the JMT/PCT for a bigger circuit.'}]},
  ...
  permit:{system:'Inyo NF (Ansel Adams Wilderness) overnight quota — Agnew Meadows / Shadow Creek, recreation.gov.',cost:'$6/permit + $5/person',where:'recreation.gov',when:'60% at 6 months; 40% two weeks prior — but ONLY released on days the Reds Meadow Rd is anticipated open',notes:'2026 Reds Meadow Road reconstruction restricts access. Camping rules: none AT Shadow Lake; none within 1/8 mi of Ediza\'s south shore; 1/4 mi off Garnet & Thousand Island outlets. Bear canister required.'},
...
{id:'laurel',name:'Laurel Lake & Lake Vernon',type:'backpack',region:'Yosemite · Hetch Hetchy',drive:3.5,len:'2–3 nts',miles:'~8/day',gain:'≤2,200/day',
 ...
 d:{tag:'Yosemite without the people — a quiet lake basin out of Hetch Hetchy where you\'ll likely see no one.',
  ...
  route:{mode:'backpack',options:[
   {name:'Laurel Lake',stat:'2 nts · ~8 mi/day',text:'O\'Shaughnessy Dam up to Laurel Lake; basecamp and explore. Steep early climb, then it eases.'},
   {name:'Laurel–Vernon loop',stat:'3 nts · ~8 mi/day',text:'Continue to Lake Vernon and loop back — bigger circuit, near-total solitude.'}]},
...
{id:'skylakes',name:'Sky Lakes Wilderness',type:'backpack',region:'Oregon · S. of Crater Lk',drive:7.5,len:'2–3 nts',miles:'~9/day',gain:'≤1,800/day',
 ...
 d:{tag:'Hundreds of lakes under Mt McLoughlin — an EPIC Oregon detour, if you time the bugs.',
  ...
  route:{mode:'backpack',options:[
   {name:'Seven Lakes Basin',stat:'2 nts · ~9 mi/day',text:'Sevenmile or Seven Lakes TH into the basin; basecamp among the lakes, day-hike Devils Peak for the view.'},
   {name:'Sky Lakes Basin via PCT',stat:'3 nts · ~9 mi/day',text:'String the PCT south past Margurette, Trapper and the Heavenly Twin Lakes — maximum lakes.'}]},
...
{id:'wallowas',name:'Eagle Cap — Lakes Basin',type:'backpack',region:'Oregon · Wallowas',drive:10.5,len:'3–4 nts',miles:'~9/day',gain:'≤2,600/day',
 ...
 d:{tag:'"Oregon\'s Alps" — white granite, golden trout, and the kind of remoteness California can\'t match. A marquee push.',
  ...
  route:{mode:'backpack',options:[
   {name:'Lakes Basin loop',stat:'3 nts · ~9 mi/day',text:'Two Pan TH up the West Fork Lostine to the Lakes Basin (Mirror, Moccasin, Douglas); basecamp, day-hike Eagle Cap summit.'},
   {name:'Grand loop',stat:'4 nts · ~9–10 mi/day',text:'Add Glacier Lake and the high traverse for the range\'s best granite and water.'}]},
...
{id:'enchant',name:'The Enchantments',type:'backpack',region:'Washington · Cascades',drive:13,len:'2–3 nts',miles:'~9/day',gain:'≤2,900/day',
 ...
 d:{tag:'The white whale — a granite-and-larch basin so good it has its own lottery. Bucket-list only.',
  ...
  route:{mode:'backpack',options:[
   {name:'Core Enchantments thru-hike',stat:'2–3 nts · ~9 mi/day · big gain',text:'Stuart Lake TH up Aasgard Pass into the Core, descend to Snow Lakes. Brutal climb, unmatched payoff. Requires a Core-zone permit.'},
   {name:'Colchuck Lake (no lottery)',stat:'day or 1 nt',text:'If the lottery fails, Colchuck Lake under Dragontail is a stunning consolation and doesn\'t need a Core permit.'}]},
...
{id:'lakesbasin',name:'Lakes Basin & Sierra Buttes',type:'car',region:'Tahoe Nat\'l Forest · Gold Lk',drive:4,len:'2–3 nts',miles:'day hikes',gain:'flexible',
 ...
 d:{tag:'A basin packed with swimmable lakes under the Sierra Buttes — the most underrated car-camping zone in California.',
  ...
  route:{mode:'car',basecamp:'Sardine Lake, Salmon Creek, or Packsaddle campgrounds in the basin.',
   dayhikes:['Sierra Buttes Lookout (stairs to the firetower — the view)','Lakes Basin loop past Long, Silver, Round','Sardine Lake to Upper Sardine','Frazier Falls (short, scenic)']},
...
{id:'junelake',name:'June Lake Loop',type:'car',region:'E. Sierra · Hwy 158',drive:5.5,len:'2–3 nts',miles:'day hikes',gain:'flexible',
 ...
 d:{tag:'Four lakes on a scenic loop, the best aspen blaze in California come October, and wild-trout creeks a short drive away.',
  ...
  route:{mode:'car',basecamp:'Silver Lake, Oh! Ridge, or Gull Lake campgrounds on the loop.',
   dayhikes:['Parker Lake (short, gorgeous)','Fern Lake / Yost Lake climbs','Rush Creek trail toward Agnew','Aspen drives in early October']},
...
{id:'bishopcreek',name:'Bishop Creek — Sabrina & South Lk',type:'car',region:'E. Sierra · Hwy 168',drive:6,len:'2–3 nts',miles:'day hikes',gain:'flexible',
 ...
 d:{tag:'13,000-ft peaks straight overhead, a legendary trout creek, and arguably the best aspen color in the state.',
  ...
  route:{mode:'car',basecamp:'Sabrina, Bishop Park, or Four Jeffrey campgrounds in the canyon.',
   dayhikes:['Treasure Lakes (from South Lake)','Blue & Dingleberry Lakes (from Sabrina)','Lamarck Lakes','Aspen color drive in early October']},
...
{id:'lassencar',name:'Lassen — Summit & Butte Lake',type:'car',region:'Lassen NP',drive:4,len:'2–3 nts',miles:'day hikes',gain:'flexible',
 ...
 d:{tag:'Cinder cones, boiling mud, bears everywhere — and Summit Lake, warm enough to swim laps in.',
  ...
  route:{mode:'car',basecamp:'Summit Lake (North/South) or Butte Lake campgrounds.',
   dayhikes:['Bumpass Hell boardwalk','Cinder Cone + Painted Dunes (from Butte Lake)','Lassen Peak summit (strenuous)','Kings Creek Falls']},
...
{id:'hatcreek',name:'Hat Creek & Burney Falls',type:'car',region:'Shasta-Cascade',drive:4.5,len:'2 nts',miles:'easy',gain:'flat',
 ...
 d:{tag:'A fly-fishing pilgrimage — California\'s most famous wild-trout riffle, plus the "eighth wonder," Burney Falls.',
  ...
  route:{mode:'car',basecamp:'McArthur-Burney Falls Memorial SP campground, or Hat Creek campgrounds.',
   dayhikes:['Burney Falls loop','Pacific Crest Trail segments','Lake Britton shoreline','Subway Cave lava tube']},
...
{id:'mccloud',name:'McCloud River Falls',type:'car',region:'Mt Shasta',drive:4.5,len:'2 nts',miles:'easy',gain:'flat',
 ...
 d:{tag:'Three waterfalls with swimming holes strung between them, Mt Shasta looming, wild trout in the run.',
  ...
  route:{mode:'car',basecamp:'Fowlers Campground (on the river by Lower Falls).',
   dayhikes:['Falls Loop: Lower → Middle → Upper Falls','Lower McCloud River trail (fishing access)','Mt Shasta viewpoints','Squaw Valley Creek side trip']},
...
{id:'steens',name:'Steens Mountain',type:'car',region:'Oregon · high desert',drive:9,len:'2–3 nts',miles:'day hikes',gain:'flexible',
 ...
 d:{tag:'Mile-deep glacial gorges, wild horses, pronghorn, and native redband trout — EPIC, and almost entirely empty.',
  ...
  route:{mode:'car',basecamp:'Page Springs, Fish Lake, or Jackman Park campgrounds (BLM).',
   dayhikes:['Kiger Gorge overlook','East Rim viewpoint (the big drop-off)','Wildhorse Lake hike','Little Blitzen gorge']},
...
{id:'pointreyes',name:'Point Reyes — Wildcat & Coast Camp',type:'backpack',region:'Marin · National Seashore',drive:1.5,len:'1–2 nts',miles:'~6/day',gain:'≤1,200/day',
 ...
 d:{tag:'Tule elk, bobcats, whales, and a waterfall pouring onto the beach — backcountry camping 90 minutes from home.',
  ...
  route:{mode:'backpack',options:[
   {name:'Wildcat Camp + Alamere',stat:'1–2 nts · ~6 mi/day',text:'Palomarin or Bear Valley to Wildcat; camp above the beach, walk to Alamere Falls and swim Bass Lake on the way.'},
...
{id:'bigsur',name:'Big Sur — Ventana & the River',type:'car',region:'Los Padres · Hwy 1',drive:2.5,len:'2 nts',miles:'day hikes',gain:'flexible',
 ...
 d:{tag:'Redwoods meeting the surf, river pools in the gorge, and blissful off-season quiet. Skip the summer crush.',
  ...
  route:{mode:'car',basecamp:'Pfeiffer Big Sur SP, or Los Padres NF campgrounds (Bottchers Gap, Kirk Creek).',
   dayhikes:['Pfeiffer Falls / Valley View loop','Big Sur River gorge pools','Andrew Molera bluff loop','Partington Cove']},
...
{id:'mendocino',name:'Mendocino Coast — Russian Gulch',type:'car',region:'Mendocino',drive:3.5,len:'2 nts',miles:'easy',gain:'flat',
 ...
 d:{tag:'A sea-tunnel blowhole, fern canyons, and dramatic headlands — the soft-landing coastal weekend.',
  ...
  route:{mode:'car',basecamp:'Russian Gulch SP or Van Damme SP campgrounds.',
   dayhikes:['Russian Gulch headland + Punch Bowl','Fern Canyon to the waterfall','Van Damme Fern Canyon','Mendocino Headlands + village']},
...
{id:'henrycoe',name:'Henry Coe — China Hole',type:'backpack',region:'Santa Clara foothills',drive:1.5,len:'1–2 nts',miles:'~8/day',gain:'≤2,500/day',
 ...
 d:{tag:'The closest real wilderness you have — wild pigs, bobcats, tarantulas, rattlers — green and flowing in the cool months.',
  ...
  route:{mode:'backpack',options:[
   {name:'China Hole overnight',stat:'1 nt · ~8 mi RT · ≤2,500 ft',text:'Headquarters down to China Hole via the Manzanita/Madrone Soda Springs route; camp by the pools, climb out the next day. The climb back is the work.'},
   {name:'Loop via Los Cruzeros',stat:'2 nts',text:'Extend to Los Cruzeros / the Narrows for more creek and solitude.'}]},
...
{id:'pinnacles',name:'Pinnacles — Talus Caves & Spires',type:'car',region:'Pinnacles NP',drive:2,len:'2 nts',miles:'day hikes',gain:'flexible',
 ...
 d:{tag:'California condors overhead, talus caves below, volcanic spires to scramble — a cool-season gem two hours away.',
  ...
  route:{mode:'car',basecamp:'Pinnacles Campground (east side).',
   dayhikes:['High Peaks loop (condors + steep cut steps)','Bear Gulch Cave + Reservoir','Balconies Cave','Condor Gulch overlook']},
...
{id:'alabamahills',name:'Alabama Hills & the Owens',type:'car',region:'Lone Pine · E. Sierra',drive:5.5,len:'2–3 nts',miles:'flexible',gain:'flexible',
 ...
 d:{tag:'Rock arches framing Mt Whitney, free dispersed camping under the Sierra crest, and a tailwater that fishes all winter.',
  ...
  route:{mode:'car',basecamp:'Alabama Hills dispersed camping (BLM, free, 14-day) or Tuttle Creek / Diaz Lake campgrounds.',
   dayhikes:['Mobius Arch loop (Whitney through the arch)','Movie Road auto tour','Whitney Portal day hike (lower)','Lone Pine Lake (if open)']},
...
{id:'deathvalley',name:'Death Valley — Saline & the Canyons',type:'car',region:'Death Valley NP',drive:8,len:'3 nts',miles:'flexible',gain:'flexible',
 ...
 d:{tag:'Winter is the only season — dunes, slot canyons, painted hills, bighorn, and a remote clothing-optional soak. EPIC.',
  ...
  route:{mode:'car',basecamp:'Furnace Creek / Stovepipe Wells campgrounds; or dispersed/backcountry by permit; Saline Valley for the springs (advanced).',
   dayhikes:['Mesquite Flat Dunes at sunrise','Golden Canyon / Gower Gulch loop','Mosaic Canyon slot','Zabriskie Point + Badwater + Artists Palette drive','Saline Valley Warm Springs (long 4WD day/overnight)']},
  fish:{water:'—',species:'—',method:'—',season:'—'},
...
{id:'anzaborrego',name:'Anza-Borrego — Palms & Badlands',type:'car',region:'Colorado Desert',drive:9,len:'2–3 nts',miles:'flexible',gain:'flexible',
 ...
 d:{tag:'Slot canyons, fan-palm oases, bighorn sheep, and the state\'s most reliable super-bloom — with free dispersed camping anywhere. EPIC.',
  ...
  route:{mode:'car',basecamp:'Free dispersed roadside camping (park rules) or Borrego Palm Canyon / Tamarisk Grove campgrounds.',
   dayhikes:['Borrego Palm Canyon oasis (bighorn)','The Slot canyon','Calcite Mine / wind caves','Font\'s Point badlands overlook','Galleta Meadows sculptures']},
  fish:{water:'—',species:'—',method:'—',season:'—'},
...
{id:'joshuatree',name:'Joshua Tree',type:'car',region:'Mojave/Colorado Desert',drive:8.5,len:'2–3 nts',miles:'flexible',gain:'flexible',
 ...
 d:{tag:'Monzogranite boulder gardens, alien trees, and the clearest winter stars in California — a scenery-and-stars pilgrimage. EPIC.',
  ...
  route:{mode:'car',basecamp:'Jumbo Rocks, Hidden Valley, or Ryan campgrounds (book ahead in season).',
   dayhikes:['Hidden Valley loop','Barker Dam','Ryan Mountain summit (views)','Cholla Cactus Garden','Keys View at sunset','Stargazing anywhere']},
  fish:{water:'—',species:'—',method:'—',season:'—'},
...
{id:'dvbackpack',name:'Death Valley — Cottonwood/Marble Loop',type:'backpack',region:'Death Valley NP',drive:8,len:'2–3 nts',miles:'~9/day',gain:'≤1,800/day',
 ...
 d:{tag:'A canyon-and-spring loop through total desert silence — bighorn, burros, sidewinders, and not a soul. Winter only.',
  ...
  route:{mode:'backpack',options:[
   {name:'Cottonwood–Marble loop',stat:'2–3 nts · ~26 mi · ≤1,800 ft/day',text:'Stovepipe Wells up Cottonwood Canyon to the springs (water!), over the divide, down Marble Canyon\'s narrows. Navigation and water-source knowledge are essential.'}]},
  fish:{water:'—',species:'—',method:'—',season:'—'},
...
{id:'ventana',name:'Ventana Wilderness — Big Sur River',type:'backpack',region:'Los Padres · Big Sur',drive:2.5,len:'1–2 nts',miles:'~7/day',gain:'≤2,200/day',
 ...
 d:{tag:'Redwood canyons and river pools above Big Sur — green and running in the wet months, and just 2.5 hours away.',
  ...
  route:{mode:'backpack',options:[
   {name:'Pine Ridge toward Sykes',stat:'1–2 nts · ~7 mi/day',text:'Big Sur Station up the Pine Ridge Trail to riverside camps and pools. Steep, hot-in-sun ridge sections then redwood shade. Distance/feasibility depend on current trail repair.'}]},
...
{id:'jtbackpack',name:'Joshua Tree — Boy Scout Trail',type:'backpack',region:'Joshua Tree NP',drive:8.5,len:'1–2 nts',miles:'~8/day',gain:'≤1,200/day',
 ...
 d:{tag:'Sleep among monzogranite giants and Joshua trees, coyotes calling, under the clearest winter stars in the state. EPIC.',
  ...
  route:{mode:'backpack',options:[
   {name:'Boy Scout Trail',stat:'1–2 nts · ~8 mi point-to-point · ≤1,200 ft',text:'Keys West to Indian Cove (or out-and-back), camping in the designated backcountry zone past the day-use mile markers. Carry all water.'}]},
  fish:{water:'—',species:'—',method:'—',season:'—'},
