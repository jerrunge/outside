...
{id:'halfdome',name:'Half Dome — Glacier Point → LYV',type:'backpack',region:'Yosemite · Valley',drive:4,len:'3 nts',miles:'~7/day',gain:'≤2,700/day',
 ...
 d:{tag:'The Panorama Trail from Glacier Point into Little Yosemite Valley, then the cables to the top of Half Dome — booked, Sep 28 – Oct 1.',
  ...
  tidePlan:{status:'Booked · Sep 28 to Oct 1, 2026',summary:'Four days, three nights, the car parked in the Valley the whole time. Mon: drive in, pick up the wilderness permit and the Half Dome add-on, sleep at Backpackers Campground. Tue: 1:30pm Glacier Point bus, Panorama Trail to LYV with a headlamp finish. Wed: Half Dome from LYV, then decide on the mountain: LYV again or down to Backpackers. Thu: out to Happy Isles and home. The 9/29 Glacier Point to LYV permit is in hand. One thing is still open, smoke: check Valley air Monday morning before you leave Pacifica (Dome Fire; forecast 134 on Thu 9/24 and 166 on Fri 9/25).',nights:[
   ...
   {label:'Night 3 · Wed Sep 30',camp:'LYV or Backpackers',zone:'Decided on the mountain: Little Yosemite Valley again, or down to Backpackers Campground. Both are legal on the permit with its 10/1 exit date',note:'Half Dome from LYV: 7.1 mi round trip, 2,667 ft. The tent stays up. Permit and photo ID checked at the base of the subdome; take the pack to the top. Dry rock only, leave the summit if a storm is near, set a turnaround time, carry a headlamp. Then choose. A second night at LYV keeps the tent up and makes Thursday a 5 mile JMT walk-out. Down to Backpackers the same day makes Wednesday a 12 mile day and Thursday only the drive; keep the Mist Trail closure in mind on the way down (Mon to Thu, 7am to 3:30pm).'}
