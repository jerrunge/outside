...
{id:'halfdome',name:'Half Dome — Glacier Point → LYV',type:'backpack',region:'Yosemite · Valley',drive:4,len:'3 nts',miles:'~7/day',gain:'≤2,700/day',
 s:[5,2,3,4,3],wild:true,skinny:false,permit:'Wilderness quota ✦ + Half Dome add-on',fish:'Merced at LYV, light',swim:'Merced at LYV (cold)',
 season:[6,7,8,9,10],peak:[9],epic:true,status:'queued',url:null,coord:[37.746,-119.533],
 blurb:'Glacier Point bus, the Panorama Trail to Little Yosemite Valley by headlamp, then the cables. Booked: Sep 28 – Oct 1, 2026. EPIC.',
 d:{tag:'The Panorama Trail from Glacier Point into Little Yosemite Valley, then the cables to the top of Half Dome — booked, Sep 28 – Oct 1.',
  over:['The classic Yosemite climb done the scenic way. Instead of grinding up from Happy Isles, you ride the afternoon bus to Glacier Point and walk the Panorama Trail down past Illilouette, over the top of Nevada Fall and into Little Yosemite Valley — then climb Half Dome from camp the next morning with the tent still standing. The Glacier Point → LYV permit carries the Half Dome add-on, and the add-on is good every day of the trip.','The car lives in the Valley trailhead lot the whole time. Monday is logistics (permit pickup, Backpackers Campground), Tuesday is the bus and a headlamp finish, Wednesday is the dome, Thursday you walk down to Happy Isles and drive home. Two things are still open and printed in the plan below: whether the 9/29 permit is actually in hand, and a Monday-morning smoke check with the Dome Fire burning south of Glacier Point.'],
  why:{scenery:'Glacier Point, Illilouette and Nevada Fall from above, then the summit of Half Dome — Yosemite’s greatest hits in three days.',fish:'Light — the Merced at LYV is a camp creek, not the plan. The rod rides only if it rides free.',wildlife:'Black-bear country (canister everywhere), mule deer in LYV, and rattlesnakes — NPS posted 9/11 that they’re increasingly common around LYV.',bugs:'Late September in a dry week — the bug season is behind you.',water:'Illilouette Creek and the Merced — cold, filterable, a rinse rather than a swim.'},
  route:{mode:'backpack',options:[
   {name:'Tue 9/29 · Glacier Point → LYV (Panorama Trail)',stat:'~7.2 mi · ~1,100 ft up / 2,200 ft down',text:'1:30pm bus to Glacier Point (arrival isn’t published — plan on about 3:00pm), then the Panorama Trail: down to Illilouette, the 800-ft climb out, along the rim to the JMT about a quarter mile above Nevada Fall, left over the Nevada Fall bridge to LYV. AllTrails logs it at 14.3 mi and 3,251 ft round trip. With a full pack from 3:00pm allow 3.5–4.5 hr — LYV between 6:30 and 7:30pm, headlamp finish.'},
   {name:'Wed 9/30 · Half Dome from LYV',stat:'7.1 mi RT · 2,667 ft',text:'Tent stays up; go with the day pack and take it all the way to the top. Permit and photo ID are checked at the base of the subdome, then the cables. Dry rock only, off the summit if a storm is near, turnaround time set before you leave camp. Back to LYV for night two — or walk out to Backpackers Campground.'},
   {name:'Thu 10/1 · Out to Happy Isles',stat:'downhill · JMT via Clark Point',text:'The Mist Trail from the junction above the Vernal Fall footbridge to the top of Vernal Fall is closed Mon–Thu 7am–3:30pm through October. Take the JMT down through Clark Point, or reach that junction after 3:30pm. No parking at Happy Isles — free Valley shuttle to the trailhead lot past Curry Village.'}]},
  fish:{water:'Merced River at Little Yosemite Valley',species:'Small trout (incidental)',method:'Optional — a few small dries at dusk if the rod comes along; CA license required',season:'Late Sept — low, clear water'},
  wild:['Black bear','Mule deer','Rattlesnake (increasingly common around LYV)','Steller’s jay'],
  water:{spots:['Illilouette Creek','Merced River at LYV','Nevada Fall (from the bridge)'],skinny:'Not a skinny-dip trip — LYV is a shared campground. A cold rinse in the Merced after the cables is the water moment.'},
  permit:{system:'Yosemite Wilderness permit (recreation.gov), Glacier Point → Little Yosemite Valley trailhead, with the Half Dome add-on. Quota 6 lottery / 4 first-come.',cost:'$10/permit + $5/person · Half Dome add-on $10/person, paid only at pickup',where:'recreation.gov; pick up in person at any open wilderness station',when:'40% released 7 days ahead at 7am PT; online booking closes 3 days before the start. Pickup the day before (8am–5pm) or the start day (8am–11am) — uncollected by 11am is cancelled unless marked for late pickup on recreation.gov.',notes:'Half Dome add-on is valid every day of the permit. Vehicle travel or passing through the Valley mid-trip invalidates the permit — the Glacier Point bus up before you start is fine. First night must be AT the LYV campground, established sites only; put Oct 1 as the exit date so a second night there stays legal. Bear canister required throughout the Yosemite Wilderness — rent one for $5/week ($95 deposit) at Big Oak Flat and other stations, return it at any station 24 hours a day. Fires: wood and charcoal, twig stoves included, banned below 8,000 ft since Aug 2 — the LYV rings are unusable; gas and alcohol stoves are fine. STATUS 9/23, 8:06am: recreation.gov showed no Glacier Point → LYV quota left for a 9/29 start; a 9/30 start had 2 of 10 left, bookable online until 9/27.'},
  drive:{time:'~4 hr',route:'Pacifica to Yosemite Valley; the car sits in the trailhead lot about half a mile past Curry Village for all four days',flags:['No parking at Happy Isles — use the trailhead lot past Curry Village; free Valley shuttle 7am–10pm','Backpackers Campground: 15-minute unloading only','All food and scented items out of the car for the whole trip','Glacier Point bus: meet at the Yosemite Valley Lodge lobby (shuttle stop 7); care on Glacier Point Road around fire traffic']},
  safety:['Cables: never when the rock is wet; leave the summit if a storm is near — the summit runs 15–20° cooler than the Valley','Set a turnaround time and carry a headlamp — NPS rules, and the Panorama day ends in the dark anyway (sunset 9/29 6:44pm, last usable light 7:10pm)','Rattlesnakes increasingly common around LYV (NPS, 9/11)','Dome Fire: 3,795 acres, 15% contained (CAL FIRE 7:19am 9/23), north of Wawona about 10 mi south of Glacier Point. Ostrander Lake trail and everything south of it closed, Chilnualna Falls closed — your route is open','Smoke: IQAir Valley 52 at 7am 9/23, forecast 134 Thu 9/24 and 166 Fri 9/25; InciWeb called Valley air UNHEALTHY the morning of 9/23','NWS 9/23: Valley sunny and dry through 9/29, highs 75–87, lows 44–54; Half Dome area highs 60–71; summit model highs 55–68, lows 30–43; rain chance 5% or lower','No drinking water at LYV or Backpackers Campground — filter at Illilouette Creek and the Merced; no tap at Nevada Fall','Cooper stays home: no dogs on trails, in the wilderness, on shuttles or in walk-in campgrounds'],
  insider:['Pick the permit up Monday (8am–5pm the day before) so Tuesday is only the bus','Buy the one-way hiker ticket ($28.50) at the Lodge front desk 15 minutes before — round trip ($72.50) is wasted when you walk down','Leave the tent up at LYV and summit light','Grippy gloves for the cables — and pack them out','Big moon both nights: 88% rising 8:17pm Tue, 79% rising 9:03pm Wed','Walk out Thursday via Clark Point — the Mist Trail closure runs until 3:30pm'],
  pack:['Bear canister (rent $5/week, $95 deposit)','Grippy gloves for the cables (pack them out)','Headlamp + spare batteries','Gas or alcohol stove — no twig stoves','Water filter (no tap at LYV, Nevada Fall or Backpackers)','Warm layers — summit lows 30–43°','Photo ID for the subdome check','Recreation.gov app for Scan and Pay (no cash)','Bus ticket money ($28.50 one way)'],
  verify:['OPEN — Is the 9/29 Glacier Point → LYV permit in hand? At 8:06am 9/23 recreation.gov showed no quota left for a 9/29 start; a 9/30 start had 2 of 10 left, bookable online until 9/27','OPEN — Monday-morning smoke check before leaving Pacifica (Dome Fire; Valley air forecast 134 Thu 9/24, 166 Fri 9/25; InciWeb said UNHEALTHY 9/23)','Exit date on the permit reads Oct 1 — keeps the second LYV night legal','Half Dome cables still up (scheduled down Oct 14) and no new cable advisory','Mist Trail closure hours (Mon–Thu 7am–3:30pm through October)','Fire restrictions and Glacier Point Road status around the Dome Fire'],
  tidePlan:{status:'Booked · Sep 28 to Oct 1, 2026',summary:'Four days, three nights, the car parked in the Valley the whole time. Mon: drive in, pick up the wilderness permit and the Half Dome add-on, sleep at Backpackers Campground. Tue: 1:30pm Glacier Point bus, Panorama Trail to LYV with a headlamp finish. Wed: Half Dome from LYV, then LYV again or Backpackers. Thu: out to Happy Isles and home. Two things are still open. First, the permit: at 8:06am 9/23 recreation.gov showed no Glacier Point to LYV quota left for a 9/29 start, and whether you already hold it is unverified; a 9/30 start had 2 of 10 left and books online until 9/27. Second, smoke: check Valley air Monday morning before you leave Pacifica (Dome Fire; forecast 134 on Thu 9/24 and 166 on Fri 9/25).',nights:[
   {label:'Night 1 · Mon Sep 28',camp:'Backpackers Campground',zone:'None yet. Yosemite Valley, the night before the wilderness permit starts',note:'Drive in, pick up the permit and the Half Dome add-on at any open station (day-before pickup 8am to 5pm; the add-on is $10 per person, paid only at pickup). Backpackers is open 9/28: $8 per person per night by Scan and Pay in the Recreation.gov app, no cash, works offline, no reservation, one night before and one after the trip. No drinking water here (North Pines). 15 minute unloading. Every food and scented item comes out of the car for the whole trip.'},
   {label:'Night 2 · Tue Sep 29',camp:'Little Yosemite Valley',zone:'Glacier Point to Little Yosemite Valley. First night must be AT the LYV campground, established sites only',note:'1:30pm bus from the Yosemite Valley Lodge lobby (shuttle stop 7), tickets at the front desk 15 minutes before, one way $28.50. Plan on about 3:00pm at Glacier Point, then about 7.2 mi of Panorama Trail with a full pack: 3.5 to 4.5 hours puts you at LYV between 6:30 and 7:30pm. Sunset 6:44pm, last usable light 7:10pm, so it is a headlamp finish. Filter at Illilouette Creek and the Merced near Nevada Fall. LYV has composting toilets and bear lockers, no drinking water.'},
   {label:'Night 3 · Wed Sep 30',camp:'LYV or Backpackers',zone:'Little Yosemite Valley (second night allowed with a 10/1 exit date), or Backpackers Campground if you walk out',note:'Half Dome from LYV: 7.1 mi round trip, 2,667 ft. The tent stays up. Permit and photo ID checked at the base of the subdome; take the pack to the top. Dry rock only, leave the summit if a storm is near, set a turnaround time, carry a headlamp. Then LYV for night two, or walk out to Backpackers, keeping the Mist Trail closure in mind (Mon to Thu, 7am to 3:30pm).'}
  ],exit:'Day 4 · Thu Oct 1: LYV out to Happy Isles and home. The Mist Trail from the junction above the Vernal Fall footbridge to the top of Vernal Fall is closed Mon to Thu 7am to 3:30pm through October, so take the JMT down through Clark Point or reach that junction after 3:30pm. No parking at Happy Isles: ride the free Valley shuttle (7am to 10pm) to the trailhead lot about half a mile past Curry Village. Return a rented bear canister at any station, 24 hours a day.'}}},
...
{id:'lostcoast',name:'Lost Coast — Mattole → Black Sands',type:'backpack',region:'King Range · BLM',drive:4,len:'3 nts',miles:'~8/day (sand)',gain:'1,522 ft total',
 ...
 d:{tag:'The most undeveloped coast in the Lower 48 — mountains straight out of the surf, wildlife maxed, naked beach camping. EPIC.',
  ...
  tidePlan:{status:'Booked · Oct 24 to 27, 2026',summary:'Mattole trailhead in, Black Sands Beach out. About 24.6 mi, 3 nights, north to south. Afternoon tide windows all four days, so each crossing day the rule is simple: reach the impassable zone as the tide opens it, not after.',nights:[
   {label:'Night 1 · Oct 24',camp:'Randall Creek',zone:'Randall-Spanish-Big Creeks',note:'Cross Zone 2 (Sea Lion Gulch to Randall, 4 mi, under 2.5 ft) in the afternoon window. Under 2.5 ft around 2:10 PM, low +0.2 ft at 4:55 PM. Camp just past the cliffs.'},
   {label:'Night 2 · Oct 25',camp:'Big Flat',zone:'Big Flat-Miller Flat',note:'Tide-free day, about 5.5 mi from Randall with no impassable zone between. Big Flat stages you at the mouth of Zone 3.'},
   {label:'Night 3 · Oct 26',camp:'Gitchell Creek',zone:'South Coast',note:'Cross Zone 3 (Miller Flat to Gitchell, about 4.5 mi, under 3 ft) in the afternoon window. Under 3 ft around 2:45 PM, low -1.0 ft at 6:19 PM right at sunset, so you cross on falling water and cannot be trapped by a rising tide. Be at Miller Flat by 2:30 PM and carry a headlamp for the last stretch.'}
  ],exit:'Day 4 · Oct 27: Gitchell to Black Sands Beach, about 3 mi, tide-free. There is no camping at the Black Sands trailhead itself.'},
...
const FISHING = {
  ...
  halfdome:{catch:1,label:'Light (incidental)',gear:'3–4 wt or ultralight spin, only if it rides free',flies:['Parachute Adams #16','Elk Hair Caddis #16','Griffith\u2019s Gnat #18'],timing:'Dusk on the Merced below camp at LYV, if the legs have anything left after the cables.'},
...
const LINKS={
  ...
  halfdome:{at:ATS+'Panorama%20Trail%20Glacier%20Point%20Half%20Dome'},
